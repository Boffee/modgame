...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("CreatureType")));
bytes32 constant CreatureTypeTableId = _tableId;
...
library CreatureType {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("CreatureType", _fieldNames);
  }
