...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("HookHandlerRegis")));
bytes32 constant HookHandlerRegistryTableId = _tableId;

library HookHandlerRegistry {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("HookHandlerRegistry", _fieldNames);
  }
