...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("MoveCommitment")));
bytes32 constant MoveCommitmentTableId = _tableId;

library MoveCommitment {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("MoveCommitment", _fieldNames);
  }
