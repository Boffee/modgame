...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("TotalSupply")));
bytes32 constant TotalSupplyTableId = _tableId;
...
library TotalSupply {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("TotalSupply", _fieldNames);
  }
