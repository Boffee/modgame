...
library Position {
  ...
  /** Get x */
  function getX(bytes32 key) internal view returns (uint128 x) {
  ...
  function getX(IStore _store, bytes32 key) internal view returns (uint128 x) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  /** Set x */
  function setX(bytes32 key, uint128 x) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  function setX(IStore _store, bytes32 key, uint128 x) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  /** Get y */
  function getY(bytes32 key) internal view returns (uint128 y) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  function getY(IStore _store, bytes32 key) internal view returns (uint128 y) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  /** Set y */
  function setY(bytes32 key, uint128 y) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  function setY(IStore _store, bytes32 key, uint128 y) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  function set(bytes32 key, uint128 x, uint128 y) internal {
  ...
  function set(IStore _store, bytes32 key, uint128 x, uint128 y) internal {
    bytes memory _data = encode(x, y);
  ...
  function decode(bytes memory _blob) internal pure returns (PositionData memory _table) {
    _table.x = (uint128(Bytes.slice16(_blob, 0)));

    _table.y = (uint128(Bytes.slice16(_blob, 16)));
  }

  /** Tightly pack full data using this table's schema */
  function encode(uint128 x, uint128 y) internal view returns (bytes memory) {
