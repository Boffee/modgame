...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("ModList")));
bytes32 constant ModListTableId = _tableId;
...
library ModList {
  ...
  function get(IStore _store) internal view returns (bytes32[] memory value) {
    bytes32[] memory _keyTuple = new bytes32[](0);
  ...
  function set(IStore _store, bytes32[] memory value) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
